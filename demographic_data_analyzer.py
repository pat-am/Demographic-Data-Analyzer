...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country = ((df.loc[(df['salary'] == '>50K'), 'native-country'].value_counts() / df['native-country'].value_counts() ) * 100).sort_values().index[-3]
    highest_earning_country_percentage = round(((df.loc[(df['salary'] == '>50K'), 'native-country'].value_counts() / df['native-country'].value_counts() ) * 100).sort_values().max(), 1)
